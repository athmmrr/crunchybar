...
<head>
    <title>Crunchy Bar - Product Detail Page</title>
    <meta charset="utf-8">
        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="assets/img/burger.jpg" alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        <!--Start Controls-->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>highgrade</strong></p>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p>Ini <strong>deskripsi</strong></p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <h6>Avaliable Taste:</h6>
                                </li>
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>Double cheese/Extra beef</strong></p>
                                </li>
                            </ul>
